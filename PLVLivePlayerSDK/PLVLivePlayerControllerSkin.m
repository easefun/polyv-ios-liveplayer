...
- (UIImageView *)noLiveImageView {
    if (!_noLiveImageView) {
        _noLiveImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:NOLIVEIMAGE]];
...
- (UIButton *)returnButton {
    if (!_returnButton) {
        ...
        [_returnButton setImage:[UIImage imageNamed:@"plv_return"] forState:UIControlStateNormal];
    }
...
- (UIButton *)playButton {
    if (!_playButton) {
        ...
        [_playButton setImage:[UIImage imageNamed:@"plv_play"] forState:UIControlStateNormal];
    }
    return _playButton;
}
...
- (UIButton *)pauseButton {
    if (!_pauseButton) {
        ...
        [_pauseButton setImage:[UIImage imageNamed:@"plv_pause"] forState:UIControlStateNormal];
...
- (UIButton *)fullScreenButton {
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"plv_fullScreen"] forState:UIControlStateNormal];
    }
...
- (UIButton *)smallScreenButton {
    if (!_smallScreenButton) {
        ...
        [_smallScreenButton setImage:[UIImage imageNamed:@"plv_smallScreen"] forState:UIControlStateNormal];
