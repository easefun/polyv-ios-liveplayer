...
- `SocketIO` 库的更新较为频繁，升级 Xcode 后编译或运行出错可查询是否存在新版本或可用版本。链接：https://cocoapods.org/?q=Socket.IO-Client-Swift
         ...
         AppId 和 AppSecrect 可以在保利威视后台获取，http://my.polyv.net/v2/login（需要登录）  

- `IJKMediaFramework.framework` 

    [ff3.2-ijk0.7.6-20170203-001](http://repo.polyv.net/ios/download/ijkplayer/vod/ff3.2-ijk0.7.6-20170203-001/IJKMediaFramework.framework-fat.zip) （当前版本）

    [ff3.3-ijk0.8.0-plv02-171212](http://repo.polyv.net/ios/download/ijkplayer/vod/ff3.3-ijk0.8.0-plv02-171212/IJKMediaFramework.framework-fat.zip) （最新版本）

        下载后可存放至工程 PolyvLiveSDK\lib 目录下，并添加至项目中

## （二）概述

`polyv-ios-liveplayer` 工程是包括POLYV直播SDK在内的DEMO，此工程基于IJKPlayer播放器，可播放FLV视频，有**延迟低、加载快**等优点，也有**聊天室的 SDK**和**弹幕功能**等。
