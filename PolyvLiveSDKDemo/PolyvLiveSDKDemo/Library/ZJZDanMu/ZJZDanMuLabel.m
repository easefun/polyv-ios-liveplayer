...
- (void)dmBeginAnimation
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (self.zjzDMLStyle == ZJZDMLRoll) {
            [UIView animateWithDuration:KZJZDMLROLLANIMATION delay:0.0f options:UIViewAnimationOptionCurveLinear animations:^{
...
- (CGFloat)dmlSpeed
{
    return (self.frame.size.width + self.superFrame.size.width)/KZJZDMLROLLANIMATION;
}
