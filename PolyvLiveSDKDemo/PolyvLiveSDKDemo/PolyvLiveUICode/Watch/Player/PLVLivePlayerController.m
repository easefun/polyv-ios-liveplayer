...
/**
 ...
 iOS-livePlayerSDK2.5.6+190221
 iOS-livePlayerSDK2.5.7+200219
 */
#define PlayerErrorDomain @"net.polyv.live"
#define PlayerVersion @"iOS-livePlayerSDK2.6.0+200828"
...
- (void)playbackFailureAnalysis {
    ...
    [[[NSURLSession sharedSession] dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        [PLVLiveReporter reportErrorWithChannel:weakSelf.channel pid:self->_pid uri:weakSelf.contentURL.absoluteString status:[NSString stringWithFormat:@"%ld",(long)responseCode] errorcode:errorCode errormsg:errormsg];
    }] resume];
}
